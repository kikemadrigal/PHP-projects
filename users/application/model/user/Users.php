    ...
    public static function obtener_usuario_por_id($conexion,$id){
		...
		if ( isset( $conexion ) ) {
			try {
				...
				$sentencia->execute();
				//echo var_dump($sentencia);
				$resultado=$sentencia->fetch();
				//echo "<hr>Se obtuvo el resultado de: ".var_dump($resultado)."<hr>";
				/**idusuario, nombreusuario,claveusuario,nivelaccesousuario,correousuario,apellidosusuario,webusuario,validadousuario */
				/*if(count($resultado)){
					$usuario=new User($resultado['idusuario'],
										 $resultado['nombreusuario'],
										 $resultado['claveusuario'],
										 $resultado['nivelaccesousuario'],
										 $resultado['correousuario'],
										 $resultado['nombrerealusuario'],
										 $resultado['apellidosusuario'],
										 $resultado['webusuario'],
										 $resultado['validadousuario']);
				}*/
				return $resultado;
			} catch ( PDOException $ex ) {
				print( "Error: " . $ex->getMessage() );
		...
		//echo "<hr>desde dentro".$usuario->getNombre()."<hr>";
		//return $usuario;
	}
